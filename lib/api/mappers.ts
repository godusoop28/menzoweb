...
export function mapUserProfile(dto: UserProfileDto, myRealId: string | null): UserProfile {
  return {
    ...
    bubbleColor: dto.bubbleColor ?? undefined,
    bubbleBorderColor: dto.bubbleBorderColor ?? undefined,
    bubbleOpacity: dto.bubbleOpacity ?? undefined,
    bubbleBorderWidth: dto.bubbleBorderWidth ?? undefined,
    bubbleRadius: dto.bubbleRadius ?? undefined,
    bubbleGlowIntensity: dto.bubbleGlowIntensity ?? undefined,
    bio: dto.bio ?? "",
    ...
    level: dto.level,
    levelName: dto.levelName ?? undefined,
    xp: dto.xp,
    xpForCurrentLevel: dto.xpForCurrentLevel,
